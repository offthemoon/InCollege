       ...
       VIEW-SEARCH-PROFILE.
           ...
           IF U-EXP-COUNT(WS-SEARCH-ID) > 0
               PERFORM VARYING WS-I FROM 1 BY 1
                   UNTIL WS-I > U-EXP-COUNT(WS-SEARCH-ID)

                   MOVE SPACES TO WS-OUT
                   STRING " Title: "
                          FUNCTION TRIM(U-EXP-TITLE(WS-SEARCH-ID, WS-I))
                       DELIMITED BY SIZE
                       INTO WS-OUT
                   END-STRING
                   PERFORM PRINT-LINE
                   ...
                   MOVE SPACES TO WS-OUT
                   STRING " Company: "
                          FUNCTION TRIM(U-EXP-COMP(WS-SEARCH-ID, WS-I))
                       DELIMITED BY SIZE
                       INTO WS-OUT
                   END-STRING
                   PERFORM PRINT-LINE
                   ...
                   MOVE SPACES TO WS-OUT
                   STRING " Dates: "
                          FUNCTION TRIM(U-EXP-DATES(WS-SEARCH-ID, WS-I))
                       DELIMITED BY SIZE
                       INTO WS-OUT
                   END-STRING
                   PERFORM PRINT-LINE
                   ...
                   MOVE SPACES TO WS-OUT
                   STRING " Description: "
                          FUNCTION TRIM(U-EXP-DESC(WS-SEARCH-ID, WS-I))
                       DELIMITED BY SIZE
                       INTO WS-OUT
                   END-STRING
                   PERFORM PRINT-LINE
           ...
           IF U-EDU-COUNT(WS-SEARCH-ID) > 0
               PERFORM VARYING WS-I FROM 1 BY 1
                   UNTIL WS-I > U-EDU-COUNT(WS-SEARCH-ID)

                   MOVE SPACES TO WS-OUT
                   STRING " Degree: "
                          FUNCTION TRIM(U-EDU-DEGREE(WS-SEARCH-ID, WS-I))
                       DELIMITED BY SIZE
                       INTO WS-OUT
                   END-STRING
                   PERFORM PRINT-LINE
                   ...
                   MOVE SPACES TO WS-OUT
                   STRING " University: "
                          FUNCTION TRIM(U-EDU-UNIV(WS-SEARCH-ID, WS-I))
                       DELIMITED BY SIZE
                       INTO WS-OUT
                   END-STRING
                   PERFORM PRINT-LINE
                   ...
                   MOVE SPACES TO WS-OUT
                   STRING " Years: "
                          FUNCTION TRIM(U-EDU-YEARS(WS-SEARCH-ID, WS-I))
                       DELIMITED BY SIZE
                       INTO WS-OUT
                   END-STRING
                   PERFORM PRINT-LINE
